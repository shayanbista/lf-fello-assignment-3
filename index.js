document.addEventListener("DOMContentLoaded", (event) => {
  ...
  const applyDarkMode = () => {
    ...
    document
      .querySelectorAll(
        ".card, .user-information__role h1, .user-information__description p, .user-information__header, .application-container, .application-wrapper, .footer, .wrapper--project,.information__tuku,.tool-information"
      )
